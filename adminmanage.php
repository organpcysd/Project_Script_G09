...
<form action="adminmanage.php" method="get" name = "myForm">
  <center>
    ...
    <td align = "center"> <a href="edit_admin.php?ID='<?php echo $row['id']; ?>'">Edit</a> <a href="delete_admin.php?ID=' <?php echo $row['id']; ?> '" onclick="return confirm('Are you sure to delete #id' + <?php echo $row['ID']; ?> + ' ?' );">Delete</a></td>
    </tr>
    <?php
    }
