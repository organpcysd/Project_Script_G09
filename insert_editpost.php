...
$sql= "UPDATE content SET topic='$Topic',detail='$Detail',address='$Address',tel='$Tel',Email='$Tel',social='$Social',content_type='$Content_type',content_check='$Content_check' WHERE id = $id";
